...
export async function GET(request: NextRequest) {
  ...
  // Daily = incremental (fast, only new jobs). Engine currently exposes
  // scrapeAllSources(sources); mode is semantic — daily reuses dedup logic
  // via storage so only truly new URLs are persisted.
